...
public class Base {
	...
	public void extractJSLogsInfo() {
		...
		for (LogEntry entry : logEntries) {
			if (entry.getMessage().contains("the server responded with a status of 500")) {
				System.out.println(ANSI_RED+"The server responded with a status of 500!"+ANSI_RESET);
